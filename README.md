...
![Pantalla principal](Godot/Img/Captura_de_pantalla3.png)
![Ejemplo de dibujo](Godot/Img/Captura_de_pantalla1.png)
![Ejemplo de dibujo](Godot/Img/Captura_de_pantalla2.png)
...
2. Ve a la carpeta `Godot/Executable/` y descomprime el archivo `.zip` que contiene el ejecutable (`PixelWallE.exe`).
